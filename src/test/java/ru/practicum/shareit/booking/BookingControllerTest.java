...
public class BookingControllerTest {
    ...
    class Add {
        ...
        public void shouldAdd() throws Exception {
            when(bookingService.createBooking(ArgumentMatchers.eq(user2.getId()), ArgumentMatchers.any(BookingRequestDto.class)))
            ...
            verify(bookingService, times(1)).createBooking(ArgumentMatchers.eq(user2.getId()),
        ...
        public void shouldThrowExceptionIfStartInPast() throws Exception {
            ...
            verify(bookingService, never()).createBooking(ArgumentMatchers.any(), ArgumentMatchers.any());
        }
    ...
    class Update {
        ...
        public void shouldApproved() throws Exception {
            ...
            when(bookingService.approveBooking(ArgumentMatchers.eq(user2.getId()), ArgumentMatchers.eq(bookingResponseDto.getId()),
            ...
            verify(bookingService, times(1)).approveBooking(ArgumentMatchers.eq(user2.getId()),
